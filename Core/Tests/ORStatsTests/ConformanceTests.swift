...
final class StatsConformanceTests: XCTestCase {
    ...
    func testPersonalBests() { assertSuite(DataChecks.personalBests()) }

    func testAggregates() { assertSuite(DataChecks.aggregates()) }

    func testDownsample() { assertSuite(DataChecks.downsample()) }
