...
final class PaceConformanceTests: XCTestCase {
    ...
    func testRollingPace() { assertSuite(EngineChecks.rollingPace()) }

    func testTargetPaceCurve() { assertSuite(EngineChecks.targetCurve()) }

    func testProgress() { assertSuite(EngineChecks.progress()) }

    func testGradeModel() { assertSuite(EngineChecks.gradeModel()) }

    func testGradeEstimator() { assertSuite(EngineChecks.gradeEstimator()) }

    func testZoneClassifier() { assertSuite(EngineChecks.zones()) }

    func testSettlingWindow() { assertSuite(EngineChecks.settling()) }
