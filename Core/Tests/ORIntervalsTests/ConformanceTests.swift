...
final class IntervalsConformanceTests: XCTestCase {
    ...
    func testWorkoutPlan() { assertSuite(IntervalChecks.plan()) }

    func testStepMachine() { assertSuite(IntervalChecks.stepMachine()) }

    func testRunTypeSemantics() { assertSuite(IntervalChecks.vo2Max()) }
