...
final class ColorConformanceTests: XCTestCase {
    ...
    func testColorScience() { assertSuite(DataChecks.colorScience()) }

    func testZonePalette() { assertSuite(DataChecks.palettes()) }
